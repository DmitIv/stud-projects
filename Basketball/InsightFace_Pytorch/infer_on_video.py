...
sys.path.append(os.path.abspath('./../retinaface_pytorch'))
import retinaface_pytorch.detector as detector
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--duration", help="perform detection for how long(in seconds)", default=3, type=int)
    ...
    mtcnn = MTCNN()
    retina = detector.Retinaface_Detector()
    print('mtcnn loaded')
    ...
    video_writer = cv2.VideoWriter('./../../data/output/test_results/video1_short/InsightFace/{}.avi'.format(args.save_name),
...
#             image = Image.fromarray(frame[...,::-1]) #bgr to rgb
            ...
            for result in results:
                ...
                face = Image.fromarray(
                    warp_and_crop_face(np.array(frame), landmarks, get_reference_facial_points(default_square=True),
                                       crop_size=(112, 112)))
